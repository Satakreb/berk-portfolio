...
export const bentoItems: BentoItem[] = [
  ...
  },
  {
    id: "data-logic",
    title: "Data & Logic",
    items: ["Python", "SQL", "MySQL", "Data Science & Analytics"],
    span: "normal",
    variant: "data",
    icon: "📊",
  },
  {
    ...
    description: "Bridging the gap between business goals and technical execution through MIS principles.",
    span: "normal",
    variant: "leadership",
    icon: "🧠",
  },
  {
    ...
    description: "Leading technical projects with strong communication and a focus on team dynamics.",
    span: "normal",
    variant: "leadership",
    icon: "🤝",
  },
  {
    id: "analytical-design",
    title: "Analytical Design",
    description: "Solving complex challenges with process optimization and structured database modeling.",
    span: "normal",
    variant: "data",
    icon: "🏗️",
  },
